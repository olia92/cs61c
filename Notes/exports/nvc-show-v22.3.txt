[:leftwards_arrow_with_hook:](../01.Makefile.md#interrobang-παρατήρηση-2)
```
$ nvc -show
...
CLANGCMD            =clang
CLANGCOMPBIN        Clang directory        =/opt/nvidia/hpc_sdk/Linux_x86_64/22.3/compilers/share/llvm/bin
...
LLVMOPTNOIDIOM      llvm optimizer - disable loop idiom recognition
LLVMOPTOLDVECTARG
LLVMOPTSKIPNATIVE   =0
LLVMOPTUSERARGS
LLVMOPTVECTARG
